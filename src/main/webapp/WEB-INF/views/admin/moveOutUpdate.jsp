    ...
    <div class="body-content">
        <form method="post" class="form-x" action="">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="date" class="input w50"  style="width: 80%" value="<fmt:formatDate  pattern="yyyy-MM-dd" type="date" value="${student.outDate}" />" id="outDate" name="outDate" size="50"   />
                </div>
            </div>
            <div class="form-group">
                <div class="label" style="width: 80%">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" style="width: 80%"  value="${student.whereOut}" name="whereOut" id="whereOut" />
                    <div class="tips"></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" style="width: 80%"  value="${student.whyOut}" name="whyOut" id="whyOut" />
                    <div class="tips"></div>
                </div>
            </div>
        </form>
