...
<body>
<form method="post" action="/moveIn/findSearchLike">
    <div class="panel admin-panel">
        <div class="panel-head"><strong class="icon-reorder"> 迁入管理</strong></div>
        ...
        <table class="table table-hover text-center">
            ...
            <c:forEach items="${list}" var="map" varStatus="status">
                <tr>
                    ...
                    <td>${map.name}</td>
                    <td>${map.studentNo}</td>
                    <td><fmt:formatDate  type="date" value="${map.inDate}" /></td>
                    <td>${map.area}${map.whereIn}</td>
                    <td>${map.whyIn}</td>
                    <td>
...
<script type="text/javascript">
    ...
    function update(id){
        layer.open({
            ...
            shade: 0.8,
            area: ['30%', '80%'],
            content: '/moveIn/toUpdate?id='+id,    //直接显示某个页面的内容
            btn:['确认','取消'],
            yes:function (index){
